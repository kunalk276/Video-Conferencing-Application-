...
@CrossOrigin(origins = {"http://localhost:3000" ,"https://video-conferencing-application-taupe.vercel.app", "https://video-conferencing-application-gamma.vercel.app/"})
@RestController
@RequestMapping("/auth")
...
public class AuthController {
    ...
    public ResponseEntity<JwtResponse> login(@RequestBody LoginRequest request) {
        ...
        return ResponseEntity.ok(new JwtResponse(token, userId,userDetails.getUsername()));
